...
xtrain_file = 'data\\train\\xtrain_clean.txt'
ytrain_file = 'data\\train\\ytrain_clean.txt'
xtest_file = 'data\\test\\xtest.txt'
xtest_file_neg = 'data\\test\\xneg_test.txt'
xtest_file_pos = 'data\\test\\xpos_test.txt'
...
while n <= 10:
    ...
    print("mean: ", (acc1 * 195 + acc2 * 186)/381)
    mean.append((acc1 * 195 + acc2 * 186)/381)
    n = n + 1
...
while True:
    ...
    if (acc1 == 0):
        print("Negative ", score1)
    else:
        print("Postive ", score1)
"""
